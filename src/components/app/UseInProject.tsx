...
export function UseInProject({ prompt, agent, label = "Use" }: { prompt: string; agent?: string; label?: string }) {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 z-20 card p-2 w-64 text-xs space-y-1">
