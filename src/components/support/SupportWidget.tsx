...
export function SupportWidget() {
  ...
  return <div className="support-widget" data-project={project} hidden={fullPage}>
    ...
    <button ref={launcher} className="support-launcher" aria-label={visible ? "Minimize live support" : "Open live support"} aria-expanded={visible} aria-controls={started ? "support-widget-panel" : undefined} onClick={() => { if (visible) close(); else { setStarted(true); setOpen(true); } }}>
