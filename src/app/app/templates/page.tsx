  ...
  return (
    <>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="template-filters flex flex-wrap mb-6">
        ...
        <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-5">
          {list.map((t) => (
            <div key={t.id} className="card template-card flex flex-col">
              <div className="template-cover">
                <iframe title={t.name} src={`/api/templates/${t.id}`} sandbox="allow-scripts" tabIndex={-1} loading="lazy" />
              </div>
