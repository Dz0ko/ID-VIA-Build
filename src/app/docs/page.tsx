    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="max-w-[1400px] mx-auto w-full px-6 py-10 md:py-14 grid lg:grid-cols-[260px_1fr] gap-10 lg:gap-16 flex-1">
        ...
        <article className="min-w-0 max-w-3xl">
          ...
          <P>Earnings land in your <K>Wallet &amp; payouts</K> on your profile. Add a payout destination (crypto: USDT, USDC, BTC, ETH on several networks, or PayPal), then request a payout of at least $10. We review and send it within 3 business days; every step is visible in the wallet.</P>
          ...
          <P>Your profile has a referral link. A friend who signs up through it gets {ref.referredSignupCredits} credits, you get {ref.referrerSignupCredits}, and {ref.referrerPaidCredits} more when they buy any paid plan. You also earn <K>5% of each successfully paid plan payment</K>, including renewals. Cash rewards are added to your wallet and can be requested via Crypto or PayPal from $10, subject to admin review. Credit packs and marketplace purchases do not earn referral commission; refunds and disputes adjust rewards. Signup rewards are capped at 10 invites per 30 days. Partners can apply for the affiliate programme and earn a percentage of every payment by the users they bring; write to <a className="text-paper underline" href={`mailto:${LEGAL_CONTACT}`}>{LEGAL_CONTACT}</a>.</P>
